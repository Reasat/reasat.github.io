...
### OOD Speech (ASR)
- First Bengali out-of-distribution speech recognition benchmark: 1100+ hours from 22,000+ contributors across 17 domains; fine-tuned GPT-based Whisper for regional Bengali ASR.
...
- BaDLAD: 33,695 annotated Bengali document samples across six domains; trained Mask R-CNN and YOLO-based object detectors for layout analysis.
[paper](https://link.springer.com/chapter/10.1007/978-3-031-41676-7_19)

### Text normalization & parsing
- Engineered normalizer and parser libraries for Abugida Unicode texts supporting 7 Indic languages; improved LLM robustness under adversarial conditions by 5--10 points across multiple metrics.
...
- Curated an MRI soft tissue tumor segmentation dataset (199 patients) and developed multimodal UNet + Segment Anything Model (SAM) approaches; achieved Dice 80% (state of the art).
